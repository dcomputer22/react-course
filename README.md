...
A hands-on repository documenting my journey learning **React** by building real-world projects, including a **chatbot** and a **full-stack ecommerce application**.

This project focuses on strengthening my frontend foundation while gradually expanding into backend development.
...
A full-stack ecommerce application simulating a real-world shopping experience.
...
```bash
git clone https://github.com/dcomputer22/react-course.git
cd react-course
```
